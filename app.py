...
WEEKLY_CONTENT = [
    {"jp": "私たちの会社に外国人がいます。", "cn": "我们公司有外国人。"},
    {"jp": "工場で新しいシステムを使います。", "cn": "在工厂使用新的系统。"},
    {"jp": "上海から東京まで飛行機で行きます。", "cn": "从上海坐飞机去东京。"},
    {"jp": "一日、三回、メールを確認します。", "cn": "一天三次确认邮件。"},
    {"jp": "毎週の金曜日にテーマ会議があります。", "cn": "每周五会有项目会议。"},
    {"jp": "駅まで歩いて10分かかります。", "cn": "走到车站要10分钟。"},
    {"jp": "この問題について担当者に確認します。", "cn": "关于这个问题会像担当确认。"}
]
