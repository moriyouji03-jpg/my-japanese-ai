...
WEEKLY_CONTENT = [
    {"jp": "このプロジェクトに専門家がいます。", "cn": "这个项目里有个专家。"},
    {"jp": "生産現場に責任者がいますか。", "cn": "在生产现场有负责人。"},
    {"jp": "日本語が話せる人はいますか。", "cn": "有会讲日语的人。"},
    {"jp": "この件に詳しい担当者がいます。", "cn": "有个负责人对这件事比较了解。"},
    {"jp": "会議室に電子白板があります。", "cn": "会议室里有电子白板。"},
    {"jp": "このプロセスは改善の余地があります。", "cn": "这个流程还有改善的余地。"},
    {"jp": "明日、二つの打ち合わせがあります。", "cn": "明天有两个会议。"}
]
