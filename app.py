...
WEEKLY_CONTENT = [
    {"jp": "私は普段、あまりテレビを見ません", "cn": "我平时不太看电视"},
    {"jp": "ここはあまり静かではありません", "cn": "这里不太安静"},
    {"jp": "今回の仕事はあまり難しくありません。", "cn": "这次的工作不怎么难。"},
    {"jp": "最近、彼はあまり元気ではありません。", "cn": "最近他不太精神。"},
    {"jp": "あのビルはとても綺麗ですね。", "cn": "那幢大楼非常漂亮。"},
    {"jp": "今年の桜はとても綺麗だった。", "cn": "今年的樱花非常漂亮。"},
    {"jp": "この小説はとても面白かった。", "cn": "这本小说非常有趣。"}
]
