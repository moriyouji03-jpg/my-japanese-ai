...
WEEKLY_CONTENT = [
    {"jp": "私は昼ご飯を食べにレストランへ行きます。", "cn": "我去餐厅吃午饭。"},
    {"jp": "私はコンビニに飲み物を買いに行きます。", "cn": "我去便利店买饮料。"},
    {"jp": "私は家に資料を取りに帰ります。", "cn": "我回家取资料。"},
    {"jp": "この料理は食べやすいです。", "cn": "这个料理容易吃。"},
    {"jp": "このペンはとても書きやすいです。", "cn": "这支笔用起来很好写。"},
    {"jp": "この説明は新人でも分かりやすいです。", "cn": "新人也容易理解这个说明。"},
    {"jp": "この資料は文字が小さくて見にくいです。", "cn": "这个资料字太小不容易看清楚。"}
]
