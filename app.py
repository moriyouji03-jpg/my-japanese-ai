...
WEEKLY_CONTENT = [
    {"jp": "声を出して朗読してください。", "cn": "请大声朗读。"},
    {"jp": "分からなかったら先生に聞いてください。", "cn": "如不明白请问老师。"},
    {"jp": "毎日、日本語を練習し続けています。", "cn": "每天持续练习日语。"},
    {"jp": "もう一度説明をしてください。", "cn": "请再说明一次。"},
    {"jp": "明日、必ず連絡してください。", "cn": "明天必须联系我。"},
    {"jp": "この本を読み終わりました、面白かった。", "cn": "这本书看完了，非常有趣。"},
    {"jp": "友達とご飯を食べ終わりました。", "cn": "和朋友吃完饭了。"}
]
