...
WEEKLY_CONTENT = [
    {"jp": "週末、一緒に映画を見に行きませんか。", "cn": "週末，一起去看电影吗？"},
    {"jp": "すみません、ペンを取っていただけませんか。。", "cn": "不好意思，能请您把笔递给我吗？"},
    {"jp": "この報告書はとても重要です。", "cn": "这份报告书非常重要。"},
    {"jp": "私はよく喫茶店で本を読みます。", "cn": "我经常在咖啡馆看书。"},
    {"jp": "彼はまだ会社にいます。", "cn": "他还在公司。"},
    {"jp": "田中さんは親切な人ですね。", "cn": "田中先生真是位亲切的人啊。"},
    {"jp": "このプロジェクトは来週までです。", "cn": "这个项目到下週为止。"}
]
