...
KANA_DATA = {
    ...
    "清音-段": {
        ...
        "え段": [("え","エ","e"), ("け","ケ","ke"), ("せ","赛","se"), ("て","特","te"), ("ね","内","ne"), ("へ","黑","he"), ("め","梅","me"), ("れ","雷","re")],
...
# --- 3. UI 布局与样式 ---
st.set_page_config(page_title="FUSION Pro v5.4", layout="wide")
...
# --- 模块：AI 词汇专家 ---
    ...
    if query:
        ...
        if display:
            ...
            if st.button("🔊 播放单词正音", key=f"p_voc_{uuid.uuid4()}"):
