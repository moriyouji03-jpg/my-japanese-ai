...
WEEKLY_CONTENT = [
    {"jp": "ご飯を食べる前に手を洗ってください。", "cn": "吃饭前请先洗手。"},
    {"jp": "この資料に目を通しておいてください。", "cn": "请先过目一下这份资料。"},
    {"jp": "困ることがあれば、いつでも声をかけてください。", "cn": "如果有什么困难，随时招呼我。"},
    {"jp": "鈴木は今、ちょっと席を外しております。", "cn": "铃木现在稍微离开了一下座位。"},
    {"jp": "道に迷ってしまって、少し遅れます。", "cn": "我迷路了，会稍微晚到一会儿。"},
    {"jp": "走ったら、会議に間に合ってよかった。", "cn": "跑了一下，总算赶上了会议太好了。"},
    {"jp": "宛先に気をつけて確認してください。", "cn": "请务必留心核对收件人。"}
]
