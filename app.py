...
WEEKLY_CONTENT = [
    {"jp": "日本語と英語と、どちらが難しいですか？", "cn": "您觉得日语和英语哪个更难？"},
    {"jp": "肉料理と魚料理と、どちらにしますか？", "cn": "肉类料理和鱼类料理，您选哪个？"},
    {"jp": "明日は試験ですから、今日は早く寝ます。", "cn": "明天有考试。所以，我今天要早点睡。"},
    {"jp": "この資料は重要ですから、よく読んでください。", "cn": "这份资料很重要。所以，请仔细阅读一下。"},
    {"jp": "ここは禁煙ですから、タバコを吸わないでください。", "cn": "这里禁烟。所以，请不要吸烟。"},
    {"jp": "彼はその分野の専門家ですから、話を聞く価値があります。", "cn": "他是那个领域的专家。所以，听他的话很有价值。"},
    {"jp": "予算が限られています。ですから、安いほうを選びます。", "cn": "预算有限。所以，我选便宜的那个。"}
]
