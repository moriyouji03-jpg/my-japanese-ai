...
WEEKLY_CONTENT = [
    {"jp": "何も言わないで、帰りました。", "cn": "什么都没说就回去了。"},
    {"jp": "メモを見ないで、話しています。", "cn": "不看笔记在发言。"},
    {"jp": "休まないで、ずっと働いています。", "cn": "一直不休息的在工作。"},
    {"jp": "会議に参加しなければなりません。", "cn": "必须参加会议。"},
    {"jp": "毎日、日本語を勉強しなければなりません。", "cn": "每天必须学日语。"},
    {"jp": "この問題を解決しなければなりません。", "cn": "这个问题必须要解决。"},
    {"jp": "確認しないで提出してはいけません。", "cn": "必须确认之后方可以提交。"}
]
