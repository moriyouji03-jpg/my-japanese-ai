...
WEEKLY_CONTENT = [
    {"jp": "私はお客様と話をしています。", "cn": "我正在和客户沟通。"},
    {"jp": "私は資料を作っています。", "cn": "我正在制作资料。"},
    {"jp": "私は車を運転しています。", "cn": "我正在开车。"},
    {"jp": "この資料を見て、意見をください。", "cn": "请看这个资料，并给我一些意见。"},
    {"jp": "彼は疲れているから、今日休んでいます。", "cn": "他因为很累，所以今天在休息。"},
    {"jp": "私は上司に確認してから進めます。", "cn": "我会先向上司确认，然后再推进。"},
    {"jp": "私は飲み物を持ってきました。", "cn": "我已经把饮料带过来了。"}
]
